		...
		<div class="container">
			<div class="product_section">
				<div class="row padding_top_0">
					...
					<!-- <div class="col-sm-2"> -->
					<button class="apply_now" onclick="showRecruitInfo()">
						채용정보보기</button>
			...
			<div class="container">
				<div class="product_section">
					<div class="row padding_top_0">
						...
						<!-- <div class="col-sm-2"> -->
						<button class="apply_now" onclick="showRecruitInfo2()">채용정보보기</button>
				...
				<div class="container">
					<div class="product_section">
						<div class="row padding_top_0">
							...
							<!-- <div class="col-sm-2"> -->
							<button class="apply_now" onclick="showRecruitInfo3()">채용정보보기</button>
					...
					<div class="container">
						<div class="product_section">
							<div class="row padding_top_0">
								...
								<!-- 	<div class="col-sm-2"> -->
								<button class="apply_now" onclick="showRecruitInfo4()">채용정보보기</button>
								<!-- 동적으로 추가될 채용정보 테이블 -->
