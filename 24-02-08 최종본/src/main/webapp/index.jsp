			...
			<div class="row">
				<div class="col-md-6">
					<div class="job_section">
						...
						<p class="dummy_text">서비스 및 판매업은 제품을 제공하는 것뿐만이 아니라, 주로 고객에 대한
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="job_section_2">
						...
						<p class="dummy_text">제조 및 건설업은 제품을 생산하거나 건설 프로젝트를 진행하는 산업으로,
			...
			<div class="row">
				<div class="col-md-6">
					<div class="job_section">
						...
						<p class="dummy_text">사무 및 전문 서비스는 주로 사무실 환경에서 일하는 업종들과 전문적인
