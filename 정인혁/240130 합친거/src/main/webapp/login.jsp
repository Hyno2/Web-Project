        ...
        <div class="collapse navbar-collapse" id="navbarNav">
         ...
         <!-- 로그인 상태에 따라 다른 링크를 출력 -->
                    <% if (SessionUtil.checkLogin(request)) { %>
                     	<div class="login_text Last"><a href="mypage.do">마이페이지</a></div>
          ...
          <div class="card-body">
            ...
            <form action="login.do" class="form-signin">
              <div class="form-label-group">
                <input type="text" id="inputId" name="id" class="form-control" placeholder="Email address" required autofocus>
              ...
              <div class="custom-control custom-checkbox mb-3">
                ...
                <label class="custom-control-label" for="customCheck1">아이디를 기억할까요?</label>
              </div>
              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">로그인 하기</button>
              <hr class="my-4">
              ...
              <p>만약 계정이 없으시다면?<a href="SignUp.html" style="margin-left: 110px; color: blue" ><b>회원가입</b></a></p> 
			<a href="#" onclick="window.open('searchID.html','아이디찾기','width =200','height=200')">아이디찾기</a> 
			<a href="#" onclick="window.open('searchPW.html','비밀번호찾기','width =200','height=200')">비밀번호찾기</a>
            </form>
          </div>
        </div>
      </div>
