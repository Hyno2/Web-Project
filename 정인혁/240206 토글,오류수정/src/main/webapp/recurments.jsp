...
<body>
		...
		<div class="container">
			<div class="product_section">
				<div class="row padding_top_0">
					...
					<!-- <div class="col-sm-2"> -->
					<button id="toggleRecruitInfoButton" class="apply_now" onclick="showRecruitInfo()">채용정보보기</button>
			...
			<div class="container">
				<div class="product_section">
					<div class="row padding_top_0">
						...
						<!-- <div class="col-sm-2"> -->
						<button id="toggleRecruitInfoButton2" class="apply_now" onclick="showRecruitInfo2()">채용정보보기</button>
				...
				<div class="container">
					<div class="product_section">
						<div class="row padding_top_0">
							...
							<!-- <div class="col-sm-2"> -->
							<button id="toggleRecruitInfoButton3" class="apply_now" onclick="showRecruitInfo3()">채용정보보기</button>
    ...
    function showRecruitInfo() {
        ...
        // 테이블 생성 및 채용 정보 추가
        var tableHtml = '<table border="1"><tr><th>제목</th><th>회사</th><th>종료일자</th><th>고용형태</th><th>수정일</th><th>링크</th></tr>';
...
$('#toggleRecruitInfoButton').click(function() {
	 // 현재 테이블의 표시 여부를 확인하여 반대로 설정합니다.
    $('#recruitInfoTable').toggle(); // 테이블 토글
});
$('#toggleRecruitInfoButton2').click(function() {
    // 현재 테이블의 표시 여부를 확인하여 반대로 설정합니다.
    $('#recruitInfoTable2').toggle(); // 테이블 토글
});
$('#toggleRecruitInfoButton3').click(function() {
	 // 현재 테이블의 표시 여부를 확인하여 반대로 설정합니다.
    $('#recruitInfoTable3').toggle(); // 테이블 토글
});
$('#toggleRecruitInfoButton4').click(function() {
	 // 현재 테이블의 표시 여부를 확인하여 반대로 설정합니다.
    $('#recruitInfoTable4').toggle(); // 테이블 토글
});
</script>
</body>
</html>