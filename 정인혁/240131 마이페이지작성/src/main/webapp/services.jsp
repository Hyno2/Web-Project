      ...
      <div class="services_item ">
        <div class="row">
          <div class="col-sm-6 col-lg-3">
            <div class="services_1"><img src="images/career1.png"></div>
            <h1 class="jobs_main">커리어 상담</h1>
            <p class="many_main">자신의 커리어를 토대로 상담을 진행합니다.</p>
            <div class="join_bt">
              <div class="join_text"><p></p><a href="#">상담하기</a></div>
            </div>
          </div>
          <div class="col-sm-6 col-lg-3">
            <div class="services_1"><img src="images/job.png"></div>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="services_1"><img src="images/selfintroduce.png"></div>
            <h1 class="jobs_main">자기소개서 컨설팅</h1>
            <p class="many_main">자신의 장점을 드러내기위한 자기소개서 컨설팅을 위해 상담을 진행합니다.</p>
            <div class="join_bt">
              <div class="join_text"><a href="#">상담하기</a></div>
            </div>
          </div>
          <div class="col-sm-6 col-lg-3">
            <div class="services_1"><img src="images/certificate.png"></div>
            <h1 class="jobs_main">자격증 상담</h1>
            <p class="many_main">자신이 가고자 하는 회사의 최소 자격정보를 토대로 자격증 플랜에 대해 상담합니다.</p>
            <div class="join_bt">
              <div class="join_text"><a href="#">상담하기</a></div>
            </div>
          </div>
