...
<body>
    ...
    <div class="Recurments_section">
    	<div class="container">
    		<div class="btn_main">
                <input type="text" class="btn_main_2" placeholder="검색내용 입력" name="Search">
                <input type="text" class="btn_main_3" placeholder="이칸은 없어도될듯" name="Email/ notifications">
            </div>
    	</div>
    </div>
    	...
    	<div class="container">
    		<div class="product_section">
    			<div class="row padding_top_0">
    				...
    				<div class="col-sm-2">
    					<button class="apply_now" onclick="window.location.href='https://www.saramin.co.kr/zf_user/search?search_area=main&search_done=y&search_optional_item=n&loc_mcd=104000%2C111000&cat_kewd=647%2C1401%2C1635%2C401%2C634%2C938%2C655%2C660%2C706%2C713%2C732%2C1263%2C1230'">지원하기</button>
    				</div>
    			</div>
    	</div>
    </div>
